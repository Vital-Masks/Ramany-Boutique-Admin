                        ...
                        <div className="row">
                            <div className="col-lg-3 col-6">
                                ...
                                <div className="small-box bg-info">
                                    ...
                                    <a href="index3.html" className="small-box-footer">More info <i className="fas fa-arrow-circle-right" /></a>
                                </div>
                            </div>
                            {/* ./col */}
                            <div className="col-lg-3 col-6">
                                    ...
                                    <div className="card-header">
                                        ...
                                        <div className="card-tools">
                                            <ul className="pagination pagination-sm">
                                                <li className="page-item"><a href="index3.html" className="page-link">«</a></li>
                                                <li className="page-item"><a href="index3.html" className="page-link">1</a></li>
                                                <li className="page-item"><a href="index3.html" className="page-link">2</a></li>
                                                <li className="page-item"><a href="index3.html" className="page-link">3</a></li>
                                                <li className="page-item"><a href="index3.html" className="page-link">»</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div className="card-tools">
                                            ...
                                            <div className="btn-group">
                                                ...
                                                <div className="dropdown-menu float-right" role="menu">
                                                    <a href="index3.html" className="dropdown-item">Add new event</a>
                                                    <a href="index3.html" className="dropdown-item">Clear events</a>
                                                    <div className="dropdown-divider" />
                                                    <a href="index3.html" className="dropdown-item">View calendar</a>
                                                </div>
                                            </div>
