...
let Header = ()=>{
  ...
  <nav className="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul className="navbar-nav ml-auto">
      ...
      <li className="nav-item dropdown">
        ...
        <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="index3.html" className="dropdown-item">
            {/* Message Start */}
            <div className="media">
              <img src="dist/img/user1-128x128.jpg" alt="ramany" className="img-size-50 mr-3 img-circle" />
          ...
          <a href="index3.html" className="dropdown-item">
            {/* Message Start */}
            <div className="media">
              <img src="dist/img/user8-128x128.jpg" alt="ramany" className="img-size-50 img-circle mr-3" />
              <div className="media-body">
                <h3 className="dropdown-item-title">
                  John Pierce
          ...
          <a href="index3.html" className="dropdown-item">
            {/* Message Start */}
            <div className="media">
              <img src="dist/img/user3-128x128.jpg" alt="ramany" className="img-size-50 img-circle mr-3" />
              <div className="media-body">
                <h3 className="dropdown-item-title">
                  Nora Silvester
      ...
      <li className="nav-item">
        <a className="nav-link" data-widget="control-sidebar" data-slide="true" href="index3.html">
